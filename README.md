...
4. [Debugging(11)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/02%20Basic%20Syntax.md#debugging)
5. [If Statement(12)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/02%20Basic%20Syntax.md#if-statement)
6. [Loops(14)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/02%20Basic%20Syntax.md#loops)
7. [Control Statement(15)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/02%20Basic%20Syntax.md#control-statement)
...
4. [Static Keyword(21)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/03%20Class.md#static-keyword)
5. [Static Inside of Class/Struct(22)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/03%20Class.md#static-inside-of-classstruct)
6. [Static in Local Scope(23)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/03%20Class.md#static-in-local-scope)
7. [Enumeration(24)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/03%20Class.md#enumeration)
8. [Constructor(25)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/03%20Class.md#constructor)
9. [Destructor(26)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/03%20Class.md#destructor)
10. [Inheritance(27)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/03%20Class.md#inheritance)
11. [Virtual Functions(28)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/03%20Class.md#virtual-functions)
...
4. [new(keyword)(39)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/05%20Constructor,%20Ternary%20operator,%20new,%20implicit%20conversion,%20operator%20overloading,%20this.md#new-keyword)
5. [Implict Conversion and Explicit Keyword(40)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/05%20Constructor,%20Ternary%20operator,%20new,%20implicit%20conversion,%20operator%20overloading,%20this.md#implict-conversion-and-explicit-keyword)
...
4. [Array Operator(46)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/06%20Object%20lifetime.md#array-operator)  
5. [Dynamic arrays(47)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/06%20Object%20lifetime.md#dynamic-arrays)  
6. [Use Vector in an optimal way(48)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/06%20Object%20lifetime.md#use-vector-in-an-optimal-way)  
7. [Use External Libraries (Static Link)(49)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/06%20Object%20lifetime.md#use-external-libraries-static-link)  
...
4. [namespace std(60)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/08.md#namespace-std)
5. [namespace(61)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/08.md#namespace)
6. [Thread(62)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/08.md#thread)
7. [Timing(63)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/08.md#timing)   
8. [Multi-dimensional array(64)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/08.md#multi-dimensional-array)  
9. [Sorting(65)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/08.md#sorting)  
...
4. [Precompiled Header(72)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/09.md#precompiled-header)
5. [dynamic_cast(73)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/09.md#dynamic_cast)
6. [Bench Marking(74)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/09.md#bench-marking)
7. [Structured Bindings(C++ 17)(75)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/09.md#structured-bindingsc-17)
8. [optional(C++ 17)(76)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/09.md#optionalc-17)
...
4. [Static Analysis(87)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/11.md#static-analysis)
5. [Argument Evaluation Order(88)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/11.md#argument-evaluation-order)
6. [Move Semantics(89)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/11.md#move-semantics)
7. [Move Assignment Operator(90)](https://github.com/jjjllxx/cpp-fundamentals/blob/main/11.md#move-assignment-operator)